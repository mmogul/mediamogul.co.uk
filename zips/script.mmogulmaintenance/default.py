...
addonPath = os.path.join(os.path.join(xbmc.translatePath('special://home'), 'addons'),'script.mmogulmaintenance')
...
def rssStartup():
    ...
    rss = feedparser.parse('http://www.mediamogul.co.uk/mediamogul.rss')
    if rss.bozo:
