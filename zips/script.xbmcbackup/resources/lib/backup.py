    ...
    def run(self,mode=-1,progressOverride=False):
        ...
        if(mode == self.Backup):
            ...
            if(utils.getSetting('backup_profiles') == 'true'):
                fileManager.addFile("-" + xbmc.translatePath('special://home/media'))
                fileManager.walkTree(xbmc.translatePath('special://home/media'))
            ...
            if(utils.getSetting('backup_profiles') == 'true'):
                fileManager.addFile('-' + self.remote_vfs.root_path + "media")
                fileManager.walkTree(self.remote_vfs.root_path + "media")
